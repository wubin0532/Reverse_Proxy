<template>
  <div class="page-grid" v-loading="loading">
    ...
    <el-dialog v-model="exportOpen" :title="$t('dashboard.backup.exportTitle')" width="440px"
      ><el-alert
        type="warning"
    ...
    <el-dialog v-model="importOpen" :title="$t('dashboard.backup.importTitle')" width="440px"
      ><el-alert
        type="error"
    ...
    <el-dialog v-model="installOpen" :title="$t('dashboard.update.installTitle')" width="440px"
      ><el-alert
...
const data = reactive({
  ...
  sys = reactive({}),
  updateStatus = reactive({ state: 'idle' })
...
const refreshPoller = useIntervalFn(load, 30000),
  statusPoller = useIntervalFn(pollStatus, 3000)
